...
public class Tiger extends AbstractTank{
	...
	public Tiger(String id,BattleField battle, int x, int y,Direction direction) {
		...
		//this.battle.updateQuadrant(y/64, x/64, id);
...
//	@Override
    ...
    private boolean checkLine(int V, int stepV, int H, int stepH){
        ...
        FieldObject tmp = null;
    	   ...
    	   do{ 
    	    tmp = this.battle.getNextFieldObject(V, H, this.getDirection());//this.battle.scanQuadrant(V+stepV,H+stepH);
